...
IPAddress server_addr(192,168,88,147);  // IP of the MySQL *server* here
...
char INSERT_SQL[] = "INSERT INTO `pa2`.`t_data` (`tanggal`, `waktu`, `supporting_file`) VALUES ('2019-04-11', '08:00:00', 'a')";
